...
这是一份面向 AI 与前沿科技投资岗位的公开研究作品集。仓库集中展示三类能力：论文方法拆解、架构级复现与评测协议设计，可审计 Agent 工具链开发，以及将技术差异转化为产品和投资判断。
...
- **Agent 工具链：** 将问题拆解、实验规划、人工审批和复盘组织成显式状态图；公开示例用离线 deterministic adapters 模拟代码变更、运行与指标收集，不连接真实研发环境。
